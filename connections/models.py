...
class MappedApartment(TimestampedModel):
    ...
    last_mapped_to_etuovi = models.DateTimeField(null=True, blank=True, auto_now_add=True)
    last_mapped_to_oikotie = models.DateTimeField(null=True, blank=True, auto_now_add=True)
