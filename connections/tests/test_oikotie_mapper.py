...
def test_elastic_to_oikotie__apartment__mapping_types():
...
def test_elastic_to_oikotie_missing__apartment__project_holding_type():
...
def test_elastic_to_oikotie_missing__apartment__project_city():
...
def test_elastic_to_oikotie_missing__housing_company__project_city():
    elastic_apartment = ApartmentMinimalFactory(project_city=None)
    try:
...
def test_elastic_to_oikotie_missing__housing_company__project_street_address():
    ...
    try:
        ...
        return
    raise Exception("Missing project_street_address should have thrown a ValueError")


def test_elastic_to_oikotie_missing__housing_company__project_postal_code():
