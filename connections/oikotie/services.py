...
def get_apartments_for_oikotie() -> Iterable:
    ...
    return (
        ...
        and apartment.publish_on_oikotie is True
...
def create_xml_apartment_file(apartments: list) -> Optional[str]:
    ...
    try:
        ...
        _logger.error("Apartment XML not created: %s", str(e), exc_info=True)
        return None
...
def create_xml_housing_company_file(housing_companies: list) -> Optional[str]:
    ...
    try:
        ...
        _logger.error("Housing company XML not created: %s", str(e), exc_info=True)
        return None
