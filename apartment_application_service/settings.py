...
env = environ.Env(
    ...
    DRUPAL_SEARCH_API_BASE_URL=(str, "http://asuntotuotanto.docker.so"),
    DRUPAL_SEARCH_API_TOKEN_URL=(str, "http://asuntotuotanto.docker.so/oauth/token"),
    ...
    DRUPAL_SEARCH_API_PAGE_SIZE=(int, 1000),
