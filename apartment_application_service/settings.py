...
OIKOTIE_APARTMENTS_BATCH_SCHEMA = env("OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL").split("/")[-1]
OIKOTIE_APARTMENTS_UPDATE_SCHEMA = env("OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL").split("/")[-1]
OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA = env("OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL").split("/")[-1]
