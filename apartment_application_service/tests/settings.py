...
OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL = test_env("OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL")
OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL = test_env("OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL")
OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL = test_env("OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL")
