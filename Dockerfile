...
RUN echo "OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL length ${#OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL} filename ${OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL##*/}"
RUN echo "OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL length ${#OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL} filename ${OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL##*/}"
RUN echo "OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL length ${#OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL} filename ${OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL##*/}"
