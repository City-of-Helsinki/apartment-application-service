...
ADD --chown=1001:1001 --chmod=755 ${OIKOTIE_APARTMENTS_BATCH_SCHEMA_URL} ${OIKOTIE_SCHEMA_DIR}
ADD --chown=1001:1001 --chmod=755 ${OIKOTIE_APARTMENTS_UPDATE_SCHEMA_URL} ${OIKOTIE_SCHEMA_DIR}
ADD --chown=1001:1001 --chmod=755 ${OIKOTIE_HOUSINGCOMPANIES_BATCH_SCHEMA_URL}  ${OIKOTIE_SCHEMA_DIR}
