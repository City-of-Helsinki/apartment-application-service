...
class TesthitasCompleteApartmentContractPdfFromData(unittest.TestCase):
    ...
    def test_pdf_content_is_correct(self):
        ...
        assert get_cleaned_pdf_texts(self.pdf_content) == [
            ...
            "Osoite Henkilötunnus tai Y-tunnus",
            "PL 58226 / Työpajankatu 8, 00099 Helsingin kaupunki 0201256-6",
            "Ostajan nimi",
            "Matti Meikäläinen",
            ...
            "040 123 4567 010101-1234",
            "Sähköposti",
            "matti.meikalainen@meikä.fi",
            "1",
            "Ostajan nimi",
            "Maija Meikäläinen",
            "Omistusosuus osakkeista (ellei omistusosuutta merkitä, oletetaan omistusosuudet yhtä",
            ...
            "Möhkälekatu 2 F 64",
            "Puhelin Henkilötunnus tai Y-tunnus",
            "050 987 6543 020202-2345",
            "Sähköposti",
            "maija.meikalainen@meikä.fi",
            "Ostajan nimi",
            "Omistusosuus osakkeista (ellei omistusosuutta merkitä, oletetaan omistusosuudet yhtä",
            "suuriksi)",
            "Osoite",
            ...
            "Testi pankki FI21 1234 5600 0007 85",
            ...
            "1 234,56 euroa on maksettava myyjän lukuun tilille nro FI21 1234 5600 0007 87",
            ...
            "oikeus saada",
            "12 %/v suuruinen hyvityskorko maksupäivän ja eräpäivän väliseltä ajalta.",
            ...
            "Osakekirja luovutetaan ostajalle, kun 12.8.2025",
            "6 Huoneiston hallinta ja maksuvelvollisuuden alkaminen",
            "Huoneiston hallinta luovutetaan ostajalle 12.8.2025",
