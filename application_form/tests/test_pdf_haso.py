...
class TestHasoContractPdfFromData(unittest.TestCase):
    ...
    def test_pdf_content_text_is_correct(self):
        ...
        assert get_cleaned_pdf_texts(self.pdf_content) == [
            ...
            '1',
            '2 Sopimuksen kohde',
            'Asumisoikeuden haltija saa asumisoikeuden perusteella yksinomaiseen '
            'käyttöönsä',
            ...
            'Sijaintikerros',
            '1) H',
            'uoneiston pinta-alalla tarkoitetaan sitä asumisoikeuden haltijan '
            'yksinomaisessa',
            'k',
            'äytössä olevaa lattiapinta-alaa, jota rajoittavat huoneistoa ympäröivien '
            'seinien',
            's',
            'isäpinnat. Siihen ei kuitenkaan lueta kuuluviksi hormiryhmien, '
            'putkikanavien, pilarien,',
            'k',
            'antavien seinien, kylmien kuistien, tuulikaappien eikä portaiden vaatimaa '
            'alaa portaiden',
            'l',
            'ähtökerroksessa eikä kellari- ja ullakkotiloja, kahdelle tai useammalle '
            'asunnolle yhteisesti',
            'k',
            'uuluvaa eteistä, käytävää, WC:tä, pesu- tai kylpyhuonetta, keittiötä tai '
            'näihin verrattavaa',
            'm',
            'uuta yhteiskäyttöön tarkoitettua, asumiseen liittyvää tilaa. Huoneiston '
            'pinta-alaa',
            'l',
            'askettaessa ei ole otettu lukuun sitä osaa lattiapinta-alasta, jonka '
            'kohdalla sisäkaton',
            'k',
            'orkeus lattiasta on pienempi kuin 160 cm. Huoneiston pinta-alaa '
            'yksittäistapauksissa',
            'm',
            'äärättäessä voidaan muillakin kuin edellä lausutuilla osin käyttää '
            'RT-kortiston tai',
            'k',
            'iinteistönhoitotiedoston ohjekorttia "Rakennuksen pinta-alat" (SFS '
            '5139-slandardi).',
            '2',
            ...
            'Asumisoikeusmaksu erääntyy maksettavaksi seuraavan maksuaikataulun '
            'mukaisesti',
            ...
            '2)',
            'Kun asumisoikeus perustetaan, oikeuden saajan on maksettava talon '
            'omistajalle',
            'as',
            'umisoikeusmaksu. Lisäksi asumisoikeuden haltijan on maksettava '
            'käyttövastiketta siten',
            'k',
            'uin asumisoikeusasunnoista annetussa laissa (393/2021) säädetään. Ehto, '
            'jonka mukaan',
            'as',
            'umisoikeuden edellytykseksi tai asumisoikeuden perusteella asetetaan '
            'asumisoikeuden',
            'hal',
            'tijalle muu kuin asumisoikeusasunnoista annetussa laissa (393/2021) '
            'tarkoitettu',
            'm',
            'aksuvelvollisuus on mitätön.',
            '3',
            '□',
            '□',
            ...
            'Luovuttajan tai häntä edeltäneiden asumisoikeuden haltijoiden huoneistoon '
            'tekemien tai',
            'hallinta-aikanaan rahoittamien kohtuullisten parannusten arvo '
            'luovutushetkellä',
            '3) A',
            'sumisoikeuden luovutus- tai lunastushinta ei saa ylittää '
            'asumisoikeusasunnoista',
            'annetun l',
            'ain (393/2021) 56 §:n mukaan määräytyvää enimmäishintaa, jonka kunta',
            'v',
            'ahvistaa. Sitoumus on siltä osin mitätön kuin luovutushinta ylittää sallitun '
            'enimmäishinnan.',
            '4)',
            'Jos asumisoikeusmaksu suoritetaan erinä, indeksin muutos lasketaan '
            'ensimmäisen erän',
            'er',
            'äpäivästä.',
            '4',
            ...
            'Asumisoikeudesta suoritettavat maksut kuitataan kokonaisuudessaan '
            'suoritetuksi',
            ...
            '(Kts myös kohta 9.1)',
            'Er',
            'änumero Eräpäivämäärä Maksuajankohdan peruste Maksuerän suuruus',
            '1. erä',
            '2. erä',
            '3. erä',
            'Viivästyskorko',
            'Erääntyneille maksuille suoritetaan korkolain (633/82) 4 §:n mukaan '
            'määräytyvää korkoa.',
            '5',
            '□',
            '□',
            ...
            '□',
            '□',
            'Merkitään, että asumisoikeus on edellä mainitun vastikkeen suorittamisen '
            'lisäksi saatu',
            'osittain lahjana',
            'perintönä',
            'testamenttina',
            ...
            'Luovutusajankohta',
            '5) A',
            'sumisoikeudenluovutus- tai lunastushinta ei saa ylittää '
            'asumisoikeusasunnoista annetun',
            'la',
            'in (393/2021) 56 §:n mukaan määräytyvää enimmäishintaa, jonka kunta '
            'vahvistaa.',
            'S',
            'itoumus on siltä osin mitätön kuin luovutushinta ylittää sallitun '
            'enimmäishinnan.',
            '3.2.',
            '2 Vastikkeeton saanto',
            'Merkitään, että asumisoikeudesta ei ole suoritettu vastiketta ja se on '
            'kokonaan saatu',
            'lahjana',
            'perintönä',
            'testamenttina',
            ...
            'Asumisoikeuden haltijat sitoutuvat maksamaan talonomistajalle '
            'käyttövastiketta (arvio',
            'käyttövastikkeesta sisään muuttaessa ks. 9.2 Muut ehdot).',
            '€/kk /m2/kk',
            'Lämmityskustannukset sisältyvät käyttövastikkeeseen',
            'Asumisoikeuden haltijat ovat velvollisia suorittamaan lisäksi seuraavia '
            'käyttökorvauksia',
            'Käyttövastikkeen maksupäivä',
            'kuukauden 5. päivä',
            'Pankkitili, jolle käyttövastike maksetaan',
            'isännöitsijä ilmoittaa myöhemmin',
            'Käyttövastikkeen määräytyminen (asumisoikeusasunnoista annetun lain 32 § ja '
            '33 §)',
            '1. Asumisoikeuden haltijalta voidaan periä käyttövastiketta',
            '2. Käyttövastikkeen suuruuden tulee määräytyä niin, että vastiketuloilla '
            'voidaan kattaa',
            'yhteisöön kuuluvien asumisoikeusasuntojen ja niihin liittyvien tilojen '
            'rahoituksen ja',
            'ylläpidon edellyttämät, kohtuullisen taloudenhoidon mukaiset menot',
            '3. Käyttövastikkeen voidaan sopia määräytyvän niin, että erilaisia menoeriä '
            'varten on',
            ...
            '5. Asuntorahasto voi vahvistaa käyttövastikkeita määrättäessä noudatettavat '
            'yleiset',
            'perusteet',
            'Käyttövastikkeen korottaminen (asumisoikeusasunnoista annetun lain 38 §)',
            '1. Milloin talon omistaja haluaa korottaa käyttövastiketta, hänen on '
            'ilmoitettava',
            'asumisoikeuden haltijalle siitä kirjallisesti',
            '2. Samalla on ilmoitettava korotuksen peruste ja uusi käyttövastike',
            '3. Korotettu käyttövastike tulee voimaan aikaisintaan kahden kuukauden '
            'kuluttua',
            'ilmoituksen tekemistä lähinnä seuraavan käyttövastikkeen maksukauden alusta',
            '4. Erikseen ei kuitenkaan tarvitse ilmoittaa lämmöstä, vedestä tai muusta '
            'huoneiston',
            'käyttöön kuuluvasta etuudesta suoritettavasta korvauksen sellaisesta '
            'korotuksesta,',
            'joka perustuu kulutuksen kasvuun tai huoneistossa asuvien henkilöiden '
            'lukumäärän',
            '7',
            '□',
            '□',
            ...
            '5. Kunkin maksukauden kulutuksen määrä on ilmoitettava asumisoikeuden '
            'haltijalle',
            '6) Käyttövastike on maksettava viimeistään toisena päivänä käyttövastikkeen '
            'maksukauden',
            'alusta lukien, jollei maksuajasta ole toisin sovittu. Käyttövastikkeen '
            'maksukautena pidetään',
            'kuukautta tai muuta ajanjaksoa, jolta käyttövastike sopimuksen mukaan on '
            'maksettava.',
            'Ehto, jonka mukaan asumisoikeuden haltijan on suoritettava käyttövastiketta '
            'ennakolta, on',
            'mitätön. Kt. asumisoikeusasunnoista annetun lain 32 §, 39 § ja 40 §.',
            '5 Asumisoikeuden kohteena olevien huoneiston ja muiden tilojen',
            'kunto',
            'Huoneisto ja muut tilat luovutetaan siinä kunnossa, missä ne '
            'luovutushetkellä ovat',
            'Talonomistaja sitoutuu suorittamaan ilman eri korvausta huoneistossa tai '
            'muissa',
            ...
            'hallinnan luovutus',
            'Asumisoikeuden haltija saa hallintaansa asumisoikeuden kohteena olevan '
            'huoneiston ja',
            'muut tilat arviolta (pvm).',
            'Tarkka muuttopäivä ilmoitetaan 3 kuukautta ennen muuttoa. Tarkat muuttoon '
            'liittyvät ohjeet',
            'lähetetään n. 6 viikkoa ennen muuttopäivää.',
            '7 Vakuuden asettaminen',
            'Asumisoikeussopimusta tehtäessä tai sopimusehtoja muutettaessa, '
            'asumisoikeuden haltijan',
            'vaihtuessa tai näihin verrattavissa tilanteissa voidaan sopia, että '
            'asumisoikeuden haltija',
            '8',
            '□',
            '□',
            'asettaa vakuuden sen vahingon varalta, joka talonomistajalle voi aiheutua '
            'siitä, että',
            'asumisoikeuden haltija laiminlyö velvollisuutensa asumisoikeuden haltijana. '
            'Jos sovittua',
            ...
            '500,00 € suuruisen rahasumman. Vakuus tulee olla maksettuna avainten '
            'luovutukseen',
            ...
            'Tämän asumisoikeussopimuksen perusteella asumisoikeuden haltija ja hänen '
            'kanssaan',
            'asumisoikeusasunnossa asuvat saavat oikeuden osallistua asumisoikeustaloaan',
            'koskevaan hallintoon ja päätöksentekoon vähintään siinä laajuudessa kuin '
            'laissa',
            ...
            'asuntolainoituksen perusteena olevaa hankinta-arvo-osuutta, talonomistaja '
            'voi tarkistaa',
            'asumisoikeusmaksua enintään määrällä, joka vastaa asumisoikeusmaksun osuutta',
            'hankinta-arvo-osuuden tarkistuksesta. Asumisoikeusmaksun tarkistusta voi '
            'vaatia',
            'maksettavaksi aikaisintaan kahden viikon kuluttua siitä, kun '
            'asumisoikeusmaksun',
            'tarkistuksesta ja sen määrästä on kirjallisesti ilmoitettu asumisoikeuden '
            'haltijalle.',
            'Asumisoikeusmaksun tarkistuksesta on asumisoikeuden haltijalle ilmoitettava '
            'viimeistään',
            ...
            'asiakirjat',
            '10',
            'Tähän sopimukseen perustuvan asumisoikeuden siirto tai muu luovutus samoin '
            'kuin',
            'asumisoikeuden nojalla haltuun saadun koko huoneiston hallinnan '
            'luovuttaminen tai',
            'huoneiston hallinnan jakaminen, huoneiston yhteiskäyttö tai sen osan '
            'luovuttaminen toiselle',
            'henkilölle määräytyy asumisoikeusasunnoista annetun lain 393/2021 mukaan. '
            'Tähän',
            'sopimukseen perustuvan asumisoikeuden pääoma-arvon panttauksesta säädetään '
            'edellä',
            'mainitun lain 58 §:ssa.',
            'Jos puolisot käyttävät asumisoikeuden nojalla hallittua huoneistoa yhteisenä '
            'asuntonaan, he',
            'vastaavat yhteisvastuullisesti asumisoikeusso pimuksesta johtuvista '
            'velvollisuuksista.',
            'Puoliso, joka ei ole asumisoikeussopimuksen osapuoli, vastaa toisen puolison '
            'muutettua',
            'huoneis tosta edelleen asumisoikeussopimuksesta johtuvien velvollisuuksien '
            'täyttämisestä',
            'niin kauan kuin hän asuu huoneistossa. Puolisoon rinnas tetaan henkilö, '
            'jonka kanssa',
            'asumisoikeuden haltija elää avioliiton omaisessa suhteessa. Ks. '
            'asumisoikeusasunnoista',
            'annetun 8 §.',
            'Asumisoikeuden lakkaamisesta huoneiston tuhouduttua tai viranomaisen '
            'kiellettyä',
            'huoneiston käyttämisen asuntona säädetään asumisoikeusasunnoista annetun '
            'lain 29 §.',
            'Tähän sopimukseen perustuva asumisoikeus voi päättyä myös sen johdosta, että',
            'talonomistaja purkaa asumisoikeussopimuksen. Talonomistajan oikeudesta '
            'purkaa',
            'asumisoikeussopimus säädetään mainitun lain 68-73§ ja 100 §. Eräissä '
            'tapauksissa on',
            'sopimuksen purkamisesta sopimusrikkomuksen johdosta varoitettava ennen kuin '
            'sopimus',
            'voidaan purkaa.',
            'Purkamalla sopimus voi päättyä jopa välittömästi. Talon omistajan on '
            'annettava',
            'asumisoikeuden haltijalle kirjallinen purkamisilmoitus. Muuttopäivä '
            'asumisoikeussopimuksen',
            'päättyessä sopimuksen purkamisen johdosta on sopimuksen päättymispäivää '
            'lähinnä',
            'seuraava arkipäivä. Muuttopäivänä asumisoikeuden haltijan on jätettävä '
            'puolet huoneistosta',
            'talonomistajan käytettäväksi sekä ennen muuttopäivää lähinnä seuraavan '
            'kolmannen',
            'päivän loppua luovutettava huoneisto kokonaan tämän hallintaan.',
            '11',
            'Allekirjoitukset',
            'Tätä sopimusta on tehty kaksi samasanaista kappaletta, toinen '
            'talonomistajalle ja toinen',
