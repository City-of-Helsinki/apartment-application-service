...
# needs to be imported for sentry mock to be initialized
from application_form.tests.conftest import mock_sentry  # noqa: F401
...
def sentry_test_func(sensitive_value):
    ...
    raise ValueError(
        f"Testing Sentry Scrubbing with values {user_name} and {sensitive_value}"
    )  # noqa: E501
