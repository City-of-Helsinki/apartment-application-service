...
from apartment.elastic.queries import get_apartment_project_uuid, get_apartment_uuids, get_project
    ...
    def create(self, validated_data):
        ...
        if reservations_in_project.exists():
            raise serializers.ValidationError(
                {"detail": "User already has offered or sold apartment in this project"},
                code=400,
            )
